...
def update_rank_thresholds(apps, schema_editor):
...
class Migration(migrations.Migration):
    dependencies = [
        ("accounts", "0002_user_bio_user_study_goal"),
    ]

    operations = [
        migrations.RunPython(update_rank_thresholds, migrations.RunPython.noop),
    ]
